...
$string['auth_openid_association_cleanup_frequency'] = 'Assocation cleanup';
$string['auth_openid_association_cleanup_frequency_info'] = 'The frequency (in hours) that the associations directory will be cleaned up.';
